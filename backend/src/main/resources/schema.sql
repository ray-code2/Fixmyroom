...
ALTER TABLE issues ADD COLUMN IF NOT EXISTS material_cost NUMERIC(12,2);
ALTER TABLE issues ADD COLUMN IF NOT EXISTS labor_cost NUMERIC(12,2);
ALTER TABLE issues ADD COLUMN IF NOT EXISTS other_cost NUMERIC(12,2);
ALTER TABLE issues ADD COLUMN IF NOT EXISTS cost_notes VARCHAR(500);
ALTER TABLE issues ADD COLUMN IF NOT EXISTS cost_status VARCHAR(20);
ALTER TABLE issues ADD COLUMN IF NOT EXISTS cost_submitted_by UUID;
